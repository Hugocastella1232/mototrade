...
<div class="max-w-3xl mx-auto py-10 px-6">
    ...
    <form method="POST" action="{{ route('admin.motos.update', $moto->id) }}">
        ...
        <input type="text" name="condition" value="{{ $moto->condition }}" class="w-full border p-2 rounded mb-4">

        <label class="block mb-2">Precio (€)</label>
        <input type="number" name="price_cents" value="{{ $moto->price_cents / 100 }}" class="w-full border p-2 rounded mb-4">
